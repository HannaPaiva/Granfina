...
$despesas = $bd->select("SELECT * FROM despesas");
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <br><br>
                  <h3 class="font-weight-bold">Tabela de despesas</h3>
                    ...
                    <tbody class="text-center">
                      ...
                      <?php foreach ($despesas as $despesa) : ?>
                        ...
                        <tr>
                          ...
                          <?php $value = Studio::aesEncriptar($despesa->id_despesa);
                          ?>
                          ...
                          <td><?= $despesa->agua ?>€</td>
                          <td><?= $despesa->energia ?>€</td>
                          <td><?= $despesa->comunicacao ?>€</td>
                          <td><?= $despesa->aluguer ?>€</td>
                                            ...
                                            <div class="d-flex flex-column align-items-center text-center">
                                              ...
                                              <div class="mt-3" style="margin-top: 0 !important;">
                                                ...
                                                <form action="?a=trocar_foto_cliente" method="POST" enctype="multipart/form-data">
                                                  ...
                                                  <button type="submit" class="btn btn-primary mr-2">confirmar foto</button>
