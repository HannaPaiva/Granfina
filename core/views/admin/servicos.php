            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <br><br>
                  <h3 class="font-weight-bold">Tabela de serviços</h3>
                  ...
                  <!-- ««««««««««««««««««« HEADERS DA TABELA »»»»»»»»»»»»»»»»»»»»»»»»»»»-->
                  <table class="table table-responsive" id="tabela-servicos">
                    ...
                    <tbody class="text-center">
                      ...
                      <?php foreach ($servicos as $servico) : ?>
                        ...
                        <tr>
                          ...
                          <?php $value = Studio::aesEncriptar($servico->cod_servico);
                          ?>
                          ...
                          <td>
                            ...
                            <div class="form-check form-switch">
                              <input class="form-check-input" name="check" type="checkbox" role="switch" id="flexSwitchCheckDefault" onclick="location.href = '?a=servico_desativar&id=<?= $servico->cod_servico ?>&status=<?= $servico->ativo ?>'" <?= $servico->ativo == "ativo" ? "checked" : "unchecked" ?>>
                              <label class="form-check-label" for="flexSwitchCheckDefault" id="status"><?= $servico->ativo ?> </label>
                            </div>
                          </td>

                          <!-- «««««««««« Data de nascimento no formato de dia/mes/ano-->

                          <td><?= $servico->tempomedio ?> </td>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <p>Você tem certeza que deseja apagar este servico?</p>
